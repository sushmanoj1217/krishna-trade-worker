...
#
# Enable later via envs:
#   FIREBASE_SYNC=on
#   FIREBASE_PROJECT_ID=<id>
#   FIREBASE_SA_JSON=<one-line JSON>  # or falls back to GOOGLE_SA_JSON
...
def _dummy_backtest() -> Dict[str, Any]:
    # Placeholder metrics; replace with real backtest outputs later
    ...
    net = round(gross * 0.98, 2)  # assume 2% frictions/taxes
