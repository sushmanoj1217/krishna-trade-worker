...
# Prefer explicit param, else defaults
...
bias = "mv_bear_mp"
snap = OCSnapshot(
spot=data["spot"], s1=data.get("s1"), s2=data.get("s2"), r1=data.get("r1"), r2=data.get("r2"),
expiry=data.get("expiry", ""), vix=None, pcr=data.get("pcr"), max_pain=mp, max_pain_dist=mpd,
bias_tag=bias, stale=False,
