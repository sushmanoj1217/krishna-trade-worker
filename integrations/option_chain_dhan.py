...
# NOTE: Endpoint path may differ; adjust if your account uses a different base.
...
# Expecting strikes list with OI fields per CE/PE.
# Pick top-2 PE OI as supports (S1,S2) and top-2 CE OI as resistances (R1,R2).
...
# Simple PCR and max pain estimation if present
pcr = oc_json.get("pcr")
